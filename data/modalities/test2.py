...
with open("males_by_event_bronze.csv", 'r') as file:
  bronze = csv.reader(file)

  with open("males_by_event_silver.csv", 'r') as file2:
    silver = csv.reader(file2)

    with open("males_by_event_gold.csv", 'r') as file3:
        ...
        with open('males_medals.csv', 'w') as out:
